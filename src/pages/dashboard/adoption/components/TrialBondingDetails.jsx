...
export default function TrialBondingDetails({ session, onClose, onUpdate }) {
            ...
            <div className="space-y-6">
              ...
              <div className="space-y-3">
                ...
                {dailyNotes.length === 0 ? (
                  ...
                  dailyNotes.slice().reverse().map((note, index) => (
                    <div
                      key={index}
                ...
                <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
                  ...
                  <div className="text-center">
                    <p className="text-3xl font-bold text-green-600">
                      {dailyNotes.filter((n) => n.type === 'positive').length}
                    </p>
                    <p className="text-sm text-gray-600">Positive Observations</p>
                  </div>
                  <div className="text-center">
                    <p className="text-3xl font-bold text-orange-600">
                      {dailyNotes.filter((n) => n.type === 'concern').length}
                    </p>
