...
export default function BookingManagement() {
  ...
  const bookings = [
    { id: 1, childName: 'Emma', parentName: 'Sarah Johnson', age: '3 years', package: 'Full-Time Monthly', date: '2026-05-25', status: 'pending' },
    { id: 2, childName: 'Oliver', parentName: 'Michael Brown', age: '4 years', package: 'Part-Time Weekly', date: '2026-05-25', status: 'approved' },
    { id: 3, childName: 'Sophia', parentName: 'Jessica Lee', age: '2 years', package: 'Hourly Care', date: '2026-05-26', status: 'pending' },
    { id: 4, childName: 'Liam', parentName: 'David Smith', age: '5 years', package: 'Full-Time Monthly', date: '2026-05-24', status: 'rejected' }
  ];
              ...
              <div key={booking.id} className="p-6 border-b border-slate-50 flex flex-col md:flex-row md:items-center justify-between hover:bg-slate-50 transition gap-4">
                ...
                {activeTab === 'pending' && (
                  <div className="flex flex-col sm:flex-row gap-3 w-full md:w-auto">
                    <button className="px-6 py-2.5 bg-green-500 hover:bg-green-600 text-white rounded-lg font-bold text-sm transition text-center">Approve</button>
                    <button className="px-6 py-2.5 bg-red-500 hover:bg-red-600 text-white rounded-lg font-bold text-sm transition text-center">Reject</button>
                  </div>
                )}
