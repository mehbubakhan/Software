...
export function Dashboard({ onNavigate }: DashboardProps) {
  ...
  useEffect(() => {
    api.get('/daycare/portal/dashboard')
      .then((res: any) => setDashboardStats(res.data))
      .catch((err: any) => console.error("Failed to load dashboard stats", err));
  }, []);
  ...
  const activeChildren = dashboardStats.activeChildren;
  const activeStaff = dashboardStats.staffCount;
  const pendingAdmissions = dashboardStats.pendingApprovals;
