    ...
    <div className="p-8 max-w-4xl mx-auto text-slate-800">
      ...
      <div className="bg-white rounded-2xl shadow-sm border border-slate-100 p-8 mb-8">
        ...
        <div className="space-y-6">
          <div>
            ...
            <select className="w-full px-4 py-2 border border-slate-200 rounded-lg focus:outline-none focus:border-purple-500 bg-white">
          ...
          <div>
            ...
            <textarea rows="3" placeholder="Describe the activity..." className="w-full px-4 py-2 border border-slate-200 rounded-lg focus:outline-none focus:border-purple-500"></textarea>
          </div>
      ...
      <div>
        ...
        <div className="space-y-4">
          {updates.map(update => (
            <div key={update.id} className="bg-white rounded-xl shadow-sm border border-slate-100 p-5 flex justify-between items-start">
              <div>
