...
export default function MeetingDetails({ meeting, onClose, onUpdate, onCancel }: MeetingDetailsProps) {
  ...
  const calculateCompatibilityScore = () => {
    const parentAvg = (Object.values(parentEvaluation) as number[]).reduce((a: number, b: number) => a + b, 0) / 4;
    const childAvg = (Object.values(childObservation) as number[]).reduce((a: number, b: number) => a + b, 0) / 4;
              ...
              <div className="bg-gray-50 p-4 rounded-lg border border-gray-200 mt-6">
                ...
                <div className="flex items-center gap-3">
                  <div className="flex-1 bg-gray-200 rounded-full h-4">
                    <div
                      className={`h-4 rounded-full ${getScoreColor((Object.values(parentEvaluation) as number[]).reduce((a, b) => a + b, 0) / 4)}`}
                      style={{ width: `${(Object.values(parentEvaluation) as number[]).reduce((a: number, b: number) => a + b, 0) / 4}%` }}
                    ></div>
                  </div>
                  <span className="text-2xl font-bold text-gray-900">
                    {Math.round((Object.values(parentEvaluation) as number[]).reduce((a: number, b: number) => a + b, 0) / 4)}
                  </span>
                </div>
              </div>
            </div>
            ...
            <div className="space-y-6">
              ...
              <div className="bg-gray-50 p-4 rounded-lg border border-gray-200 mt-6">
                ...
                <div className="flex items-center gap-3">
                  <div className="flex-1 bg-gray-200 rounded-full h-4">
                    <div
                      className={`h-4 rounded-full ${getScoreColor((Object.values(childObservation) as number[]).reduce((a, b) => a + b, 0) / 4)}`}
                      style={{ width: `${(Object.values(childObservation) as number[]).reduce((a: number, b: number) => a + b, 0) / 4}%` }}
                    ></div>
                  </div>
                  <span className="text-2xl font-bold text-gray-900">
                    {Math.round((Object.values(childObservation) as number[]).reduce((a: number, b: number) => a + b, 0) / 4)}
                  </span>
                </div>
              </div>
            </div>
                ...
                <div className="space-y-4">
                  <div>
                    ...
                    <div className="w-full bg-gray-200 rounded-full h-2">
                      <div
                        className={`h-2 rounded-full ${getScoreColor((Object.values(parentEvaluation) as number[]).reduce((a, b) => a + b, 0) / 4)}`}
                        style={{ width: `${(Object.values(parentEvaluation) as number[]).reduce((a: number, b: number) => a + b, 0) / 4}%` }}
                      ></div>
                    </div>
                  </div>
                  <div>
                    ...
                    <div className="w-full bg-gray-200 rounded-full h-2">
                      <div
                        className={`h-2 rounded-full ${getScoreColor((Object.values(childObservation) as number[]).reduce((a, b) => a + b, 0) / 4)}`}
                        style={{ width: `${(Object.values(childObservation) as number[]).reduce((a: number, b: number) => a + b, 0) / 4}%` }}
                      ></div>
                    </div>
                  </div>
