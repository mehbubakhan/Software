    ...
    <div className="bg-slate-50 min-h-[calc(100vh-68px)] text-slate-800 -m-6 p-8 font-sans pb-24">
      <div className="max-w-6xl mx-auto mt-4">
        ...
        <div className="flex justify-between items-center mb-8">
          <button onClick={() => navigate(-1)} className="text-slate-400 hover:text-slate-800 flex items-center gap-2 transition text-sm font-semibold">
            ← Back to Dashboard
          </button>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-4 gap-6">
          ...
          <div className="lg:col-span-1 space-y-6">
            <div className="bg-white border border-slate-200 rounded-2xl p-4 h-[500px] overflow-y-auto">
              ...
              <div className="space-y-2">
                {rooms.map(room => (
                  <button
                    ...
                    className={`w-full text-left px-4 py-3 rounded-xl transition ${activeRoom === room.name ? 'bg-fuchsia-600 text-white' : 'bg-slate-50 border border-slate-200 text-slate-600 hover:border-fuchsia-500 hover:text-fuchsia-400'}`}
                  >
            ...
            <div className="bg-white border border-slate-200 rounded-2xl p-6">
              <h3 className="text-slate-800 font-bold mb-4">Live CCTV Features</h3>
          ...
          <div className="lg:col-span-3 space-y-6">
            ...
            <div className="bg-white border border-slate-200 rounded-2xl overflow-hidden shadow-2xl relative">
              <div className="absolute top-4 left-4 z-10 bg-red-500 text-slate-800 text-xs font-bold px-3 py-1 rounded flex items-center gap-2">
                <span className="w-2 h-2 bg-white rounded-full animate-pulse"></span> LIVE
              </div>
              <div className="absolute top-4 right-4 z-10 text-slate-800 text-xs bg-black/50 px-3 py-1 rounded">
                3:45:01 PM
              </div>
              ...
              <div className="w-full aspect-video bg-black flex flex-col items-center justify-center relative group overflow-hidden">
                ...
                <div className="z-10 absolute bottom-4 left-4 bg-black/60 px-3 py-2 rounded-lg">
                  <div className="text-slate-800 font-bold text-xl">{activeRoom}</div>
              ...
              <div className="bg-white p-4 flex items-center justify-between border-t border-slate-200">
                <div className="flex items-center gap-4">
                  ...
                  <button className="text-slate-400 hover:text-slate-800 transition">⟲</button>
                  <button className="text-slate-400 hover:text-slate-800 transition">🔈</button>
                </div>
                <div className="flex items-center gap-4">
                  <button className="text-sm font-semibold text-slate-600 border border-slate-600 px-4 py-1.5 rounded-lg hover:text-slate-800 hover:border-slate-400 transition flex items-center gap-2">
                    ⬇ Save Clip
                  </button>
                  <button className="text-slate-400 hover:text-slate-800 transition">⛶</button>
                </div>
            ...
            {/* RECENT RECORDINGS */}
            <div className="bg-white border border-slate-200 rounded-2xl p-6">
              <h3 className="text-slate-800 font-bold mb-4">Recent Recordings (Last 7 Days)</h3>
              <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                {recentRecordings.map(rec => (
                  <div key={rec.id} className="bg-slate-50 border border-slate-200 rounded-xl p-4 flex items-center justify-between hover:border-fuchsia-500 transition cursor-pointer group">
                    <div className="flex items-center gap-4">
