    ...
    <div className="bg-[#111322] min-h-[calc(100vh-68px)] text-slate-100 -m-6 p-8 font-sans">
      <div className="max-w-5xl mx-auto">
        ...
        <div className="mb-8">
          ...
          <p className="text-slate-400">Each child deserves a loving home. Browse profiles to learn about their personalities, interests, and needs.</p>
        </div>

        {/* Filters */}
        <div className="bg-[#1a1c2d] border border-slate-700 rounded-2xl p-6 mb-8">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
            <div>
              ...
              <select className="w-full bg-slate-800 border border-slate-700 text-white rounded-lg px-4 py-2.5 outline-none focus:border-fuchsia-500 text-sm">
            ...
            <div className="flex flex-col justify-end">
              <label className="block text-xs text-slate-400 mb-1">Results</label>
              <div className="bg-slate-800 border border-slate-700 rounded-lg px-4 py-2.5 text-sm text-fuchsia-400 font-semibold text-center h-full flex items-center justify-center">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
          {loading ? (
            <div className="col-span-3 text-center text-slate-400 py-12">Loading profiles...</div>
          ) : (
            children.map(child => (
              <div key={child.id} className="bg-[#1a1c2d] border border-slate-700 rounded-2xl overflow-hidden hover:border-fuchsia-500 transition group flex flex-col">
                ...
                <div className="p-6 flex-1 flex flex-col">
                  ...
                  <div className="flex gap-2 mt-auto">
                    ...
                    <button className="bg-transparent hover:bg-slate-800 border border-slate-600 text-white p-2.5 rounded-xl transition flex items-center justify-center">
                      ♡
                    </button>
                  </div>
