      ...
      <div className="max-w-4xl mx-auto">
        ...
        <div className="flex items-center justify-between mb-10 max-w-2xl mx-auto">
          <div className={`flex flex-col items-center gap-2 ${step >= 1 ? 'text-fuchsia-400' : 'text-slate-500'}`}>
            <div className={`w-10 h-10 rounded-full flex items-center justify-center font-bold ${step >= 1 ? 'bg-fuchsia-600 text-white' : 'bg-slate-800'}`}>1</div>
            <div className="text-sm font-semibold">Personal Info</div>
          </div>
          <div className={`flex-1 h-1 mx-4 ${step >= 2 ? 'bg-fuchsia-600' : 'bg-slate-800'}`}></div>
          <div className={`flex flex-col items-center gap-2 ${step >= 2 ? 'text-fuchsia-400' : 'text-slate-500'}`}>
            <div className={`w-10 h-10 rounded-full flex items-center justify-center font-bold ${step >= 2 ? 'bg-fuchsia-600 text-white' : 'bg-slate-800'}`}>2</div>
            <div className="text-sm font-semibold">Household Details</div>
          </div>
          <div className={`flex-1 h-1 mx-4 ${step >= 3 ? 'bg-fuchsia-600' : 'bg-slate-800'}`}></div>
          <div className={`flex flex-col items-center gap-2 ${step >= 3 ? 'text-fuchsia-400' : 'text-slate-500'}`}>
            <div className={`w-10 h-10 rounded-full flex items-center justify-center font-bold ${step >= 3 ? 'bg-fuchsia-600 text-white' : 'bg-slate-800'}`}>3</div>
        ...
        <div className="bg-[#1a1c2d] border border-slate-700 rounded-2xl p-8">
          <form onSubmit={handleSubmit}>
            ...
            {step === 2 && (
              <div className="space-y-6">
                <h3 className="text-xl font-bold text-white mb-6">Household & Financial Details</h3>
                <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                  <div>
            ...
            {/* Navigation Buttons */}
            <div className="mt-10 flex justify-between pt-6 border-t border-slate-700">
              {step > 1 ? (
                <button 
                  type="button" 
