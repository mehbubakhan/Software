    ...
    <nav className="sticky top-0 z-30 border-b border-white/70 bg-white/75 px-4 py-3 shadow-sm shadow-fuchsia-900/5 backdrop-blur-xl sm:px-6">
      <div className="mx-auto flex max-w-7xl items-center justify-between gap-4">
        ...
        <div className="hidden md:flex items-center gap-6 text-xs font-bold uppercase tracking-wider text-slate-500">
          ...
          <Link to="/dashboard/parent/hire-nanny" className="hover:text-fuchsia-600 transition">Nanny</Link>
          <Link to="/dashboard/parent/daycare" className="hover:text-fuchsia-600 transition">Daycare</Link>
          <Link to="/dashboard/parent/adoption" className="hover:text-fuchsia-600 transition">Adoption</Link>
          <Link to="/dashboard/parent/marketplace" className="hover:text-fuchsia-600 transition">Shop</Link>
        ...
        <div className="flex items-center gap-4">
          ...
          <button className="text-slate-400 hover:text-fuchsia-600 transition">
          ...
          {user && (
            <button onClick={logout} className="ml-4 text-xs font-bold text-slate-400 hover:text-slate-600">
              Logout
            </button>
          )}
        </div>
