...
interface ChildProfileProps {
  child: any;
  onClose: () => void;
  onUpdate: (child: any) => void;
  onRemove: (childId: string, reason: string) => void;
}

export default function ChildProfile({ child, onClose, onUpdate, onRemove }: ChildProfileProps) {
