        ...
        <div className="space-y-5">
          ...
          <section>
            ...
            <div className="grid grid-cols-2 gap-3">
              <Field label="Full Name"><input value={form.name} onChange={e => ff("name", e.target.value)} className={INP} /></Field>
              <Field label="Nickname"><input value={form.nickname} onChange={e => ff("nickname", e.target.value)} className={INP} /></Field>
              <Field label="Date of Birth"><input type="date" value={form.dob} onChange={e => ff("dob", e.target.value)} className={INP} /></Field>
              <Field label="Age"><input type="number" value={form.age} onChange={e => ff("age", Number(e.target.value))} className={INP} min={0} max={10} /></Field>
              <Field label="Gender">
                <select value={form.gender} onChange={e => ff("gender", e.target.value)} className={SEL}>
                  <option>Female</option><option>Male</option>
                </select>
              </Field>
              <Field label="Blood Group">
                <select value={form.bloodGroup} onChange={e => ff("bloodGroup", e.target.value)} className={SEL}>
                  {["A+","A-","B+","B-","O+","O-","AB+","AB-"].map(g => <option key={g}>{g}</option>)}
                </select>
              </Field>
              <Field label="Religion"><input value={form.religion} onChange={e => ff("religion", e.target.value)} className={INP} /></Field>
              <Field label="Nationality"><input value={form.nationality} onChange={e => ff("nationality", e.target.value)} className={INP} /></Field>
              <Field label="Language"><input value={form.language} onChange={e => ff("language", e.target.value)} className={INP} /></Field>
              <Field label="Group">
                <select value={form.group} onChange={e => ff("group", e.target.value)} className={SEL}>
          ...
          <section>
            ...
            <div className="grid grid-cols-2 gap-3">
              <Field label="Parent Name"><input value={form.parentName} onChange={e => ff("parentName", e.target.value)} className={INP} /></Field>
              <Field label="Emergency Contact"><input value={form.emergencyContact} onChange={e => ff("emergencyContact", e.target.value)} className={INP} /></Field>
              <Field label="Emergency Phone"><input value={form.emergencyPhone} onChange={e => ff("emergencyPhone", e.target.value)} className={INP} /></Field>
              <Field label="Allergies"><input value={form.allergies} onChange={e => ff("allergies", e.target.value)} placeholder="None / Peanuts…" className={INP} /></Field>
            </div>
          </section>
          ...
          <section>
            ...
            <div className="grid grid-cols-2 gap-3">
              <Field label="Package Type">
                <select value={form.packageType} onChange={e => ff("packageType", e.target.value)} className={SEL}>
                  <option>Full Day</option><option>Half Day</option><option>Hourly</option>
                </select>
              </Field>
              <Field label="Package Expiry"><input type="date" value={form.packageExpiry} onChange={e => ff("packageExpiry", e.target.value)} className={INP} /></Field>
              <Field label="Enroll Date"><input type="date" value={form.enrollDate} onChange={e => ff("enrollDate", e.target.value)} className={INP} /></Field>
              <Field label="Assigned Nanny">
                <select value={form.assignedNanny} onChange={e => ff("assignedNanny", e.target.value)} className={SEL}>
          ...
          <section>
            ...
            <div className="grid grid-cols-2 gap-3">
              <Field label="Vaccination">
                <select value={form.vaccinationStatus} onChange={e => ff("vaccinationStatus", e.target.value)} className={SEL}>
                  <option>Up to date</option><option>Partial</option><option>Not vaccinated</option>
                </select>
              </Field>
              <Field label="Health Status">
                <select value={form.healthStatus} onChange={e => ff("healthStatus", e.target.value)} className={SEL}>
                  <option>Good</option><option>Fair</option><option>Needs Attention</option>
                </select>
              </Field>
              <div className="col-span-2"><Field label="Medical Conditions"><input value={form.medicalConditions} onChange={e => ff("medicalConditions", e.target.value)} placeholder="None" className={INP} /></Field></div>
              <div className="col-span-2"><Field label="Medical History"><textarea rows={2} value={form.medicalHistory} onChange={e => ff("medicalHistory", e.target.value)} className={`${INP} resize-none`} /></Field></div>
              <div className="col-span-2"><Field label="Special Care Instructions"><textarea rows={2} value={form.specialCareInstructions} onChange={e => ff("specialCareInstructions", e.target.value)} className={`${INP} resize-none`} /></Field></div>
              <Field label="Special Needs">
                <div className="flex items-center gap-2 h-9">
                  <input type="checkbox" checked={form.specialNeeds} onChange={e => ff("specialNeeds", e.target.checked)} className="w-4 h-4" />
              ...
              <div>
                ...
                <div className="bg-indigo-50 rounded-xl p-3 mb-4">
                  ...
                  <div className="grid grid-cols-2 gap-2">
                    <select value={newTimeline.type} onChange={e => setNewTimeline(p => ({ ...p, type: e.target.value as any }))}
                    ...
                    <input value={newTimeline.time} onChange={e => setNewTimeline(p => ({ ...p, time: e.target.value }))}
                      placeholder="Time (e.g. 02:00 PM)"
                      className="border border-gray-200 rounded-lg px-2 py-1.5 text-xs bg-white focus:outline-none focus:ring-2 focus:ring-indigo-500" />
                    <input value={newTimeline.title} onChange={e => setNewTimeline(p => ({ ...p, title: e.target.value }))}
                      placeholder="Title"
                      className="border border-gray-200 rounded-lg px-2 py-1.5 text-xs bg-white focus:outline-none focus:ring-2 focus:ring-indigo-500" />
                    <input value={newTimeline.detail} onChange={e => setNewTimeline(p => ({ ...p, detail: e.target.value }))}
                      placeholder="Details"
                      className="border border-gray-200 rounded-lg px-2 py-1.5 text-xs bg-white focus:outline-none focus:ring-2 focus:ring-indigo-500" />
                  </div>
