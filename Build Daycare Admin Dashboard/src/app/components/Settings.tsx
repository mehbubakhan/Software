            ...
            <Card className="p-6">
              ...
              <div className="grid grid-cols-2 gap-4">
                ...
                <div className="col-span-2">
                  ...
                  <textarea value={general.description} onChange={e => gf("description", e.target.value)} rows={2}
            ...
            <Card className="p-6">
              ...
              <div className="grid grid-cols-2 gap-4">
                ...
                <div className="flex flex-col gap-1">
                  ...
                  <select value={schedule.daysOpen} onChange={e => sf("daysOpen", e.target.value)}
                  ...
                  <div key={n.label} className="grid grid-cols-[1fr_auto_auto_auto] gap-4 items-center p-4 bg-gray-50 rounded-xl">
                    <div>
                      <div className="flex items-center gap-2">
                        ...
                        {n.urgent && <Badge color="red">Critical</Badge>}
                      </div>
