        ...
        <div className="space-y-5">
          ...
          <Card className="p-4">
            <div className="flex flex-wrap items-center gap-3">
              ...
              <select value={filterVerified} onChange={e => setFilterVerified(e.target.value as "All" | "Verified" | "Unverified")}
                className="border border-gray-200 rounded-lg px-2.5 py-1.5 text-xs bg-white focus:outline-none focus:ring-2 focus:ring-indigo-500">
                  ...
                  <div className="flex items-start gap-3">
                    ...
                    <div className="flex-1 min-w-0">
                      <div className="flex flex-wrap items-center gap-2">
                        ...
                        {r.verified && <CheckCircle size={13} className="text-green-500" title="Verified parent" />}
        ...
        <div className="space-y-5">
          <div className="grid grid-cols-2 lg:grid-cols-4 gap-4">
            {DISPLAY_PAGES.map(page => {
              ...
              const icons: Record<DisplayPage, JSX.Element> = {
