...
router.post('/portal/children', ensureDaycare, addChild);
...
router.get('/portal/parents', ensureDaycare, getParents);
router.post('/portal/parents', ensureDaycare, addParent);
